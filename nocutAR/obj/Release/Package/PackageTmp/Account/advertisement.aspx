...
<%@ Page Title="" Language="C#" MasterPageFile="~/Account/UserPage.Master" AutoEventWireup="true"
    CodeBehind="advertisement.aspx.cs" Inherits="jobworld.Account.advertisement" %>
...
<asp:Content ID="Content10" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function onBanner()
        {
            ...
            document.getElementById("viewBanner").style.display = "";
        ...
        function onFullAD()
        {
            ...
            document.getElementById("viewFullAD").style.display = "";
                                ...
                                <td width="410" height="49">
                                    <table cellpadding="0" cellspacing="0" align="center" width="290">
                                        <tbody><tr>
                                            ...
                                            <td width="145" height="36">
                                                <a style="cursor:pointer" onclick="onClosePopup();"><img src="IMG/bt_cancel.png"  alt=""/></a>
                                            </td>
                                        </tr>
                                    </tbody></table>
                                </td>
