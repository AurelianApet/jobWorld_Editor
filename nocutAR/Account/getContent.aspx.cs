        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (count > 0)
                {
                    ...
                    //                    string[] con_str = Regex.Split(econtent, "\r\n");
                    ...
                    string author = PageDataSource.Tables[0].Rows[0][19].ToString();
                    responseXml.Append(author);
                    responseXml.Append("</author>");
                    responseXml.Append("<regdate>");
                    string regdate = PageDataSource.Tables[0].Rows[0][8].ToString();
                    if(regdate.Length > 8)
                    {
