    ...
    public partial class PostUpload : Common.PageBase
    {
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            if (type == 1)
            {
                ...
                strIconPath = uploadFile(Request.Files["upfile"], "../advertisement",  System.IO.Path.GetFileName(Request.Files["upfile"].FileName));
            ...
            {
                strIconPath = uploadFile(Request.Files["upfile"], "../articleFiles", System.IO.Path.GetFileName(Request.Files["upfile"].FileName));
                //                Resize(strIconPath);
                try
                {
